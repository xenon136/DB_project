...
// default gulp task
gulp.task('default', gulp.series('scss:theme', 'inject', 'serve', function (done) {
    gulp.watch('./src/theme_assets/sass/**/*', gulp.series('scss:theme'));
    gulp.watch('./src/vendor_assets/css/bootstrap/*.scss', gulp.series('scss:bs'));
...
//'imgoptimize'
gulp.task('build:optimize', gulp.series('distAssets', 'imgoptimize', function (done) {
    gulp.src('dist/*.html')
        .pipe(gulpInject(
